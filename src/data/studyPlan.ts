...
export const studyModules: StudyModule[] = [
  {
    ...
    highlights: [
      ...
      'Teoría: principio de Huygens',
      'Teoría: difracción',
      'Teoría: leyes de la reflexión y la refracción',
      'Teoría: ondas estacionarias',
      'Teoría: efecto Doppler',
      'Teoría: cualidades del sonido',
    ],
    gap: 'El tema existe, pero está troceado en imágenes y conviene unirlo en una ficha única.',
    resources: [
      { label: 'Teoría', path: 'content/apuntes/01-ondas', status: 'apuntes parciales' },
      { label: 'Fórmulas', path: 'content/formulas/01-ondas', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'bloque 1.ª evaluación' },
  ...
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/02-sonido', status: 'solo un apunte directo' },
      { label: 'Fórmulas', path: 'content/formulas/02-sonido', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'bloque 1.ª evaluación' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/03-gravitacion', status: 'apuntes cortos' },
      { label: 'Fórmulas', path: 'content/formulas/03-gravitacion', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'bloque 1.ª evaluación' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/04-campo-electrico', status: 'apuntes parciales' },
      { label: 'Fórmulas', path: 'content/formulas/04-campo-electrico', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'parciales de electromagnetismo' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/05-campo-magnetico', status: 'apuntes parciales' },
      { label: 'Fórmulas', path: 'content/formulas/05-campo-magnetico', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'parciales de electromagnetismo' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/06-induccion-electromagnetica', status: 'apuntes parciales' },
      { label: 'Fórmulas', path: 'content/formulas/06-induccion-electromagnetica', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'bloque 2.ª evaluación' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/08-optica-fisica', status: 'sin apuntes directos detectados' },
      { label: 'Fórmulas', path: 'content/formulas/08-optica-fisica', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'finales de electromagnetismo y óptica física' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/09-optica-geometrica', status: 'apuntes visuales' },
      { label: 'Fórmulas', path: 'content/formulas/09-optica-geometrica', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'parciales de 3.ª evaluación' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/10-relatividad-especial', status: 'apunte muy corto' },
      { label: 'Fórmulas', path: 'content/formulas/10-relatividad-especial', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'parciales de 3.ª evaluación' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    resources: [
      { label: 'Teoría', path: 'content/apuntes/11-fisica-cuantica', status: 'tema bien cubierto' },
      { label: 'Fórmulas', path: 'content/formulas/11-fisica-cuantica', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'parciales de física moderna' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
  {
    ...
    gap: 'Tema bien situado para convertirse pronto en sección completa dentro de la app.',
    resources: [
      { label: 'Teoría', path: 'content/apuntes/12-fisica-nuclear', status: 'tema bien cubierto' },
      { label: 'Fórmulas', path: 'content/formulas/12-fisica-nuclear', status: 'formulario rápido disponible' },
      { label: 'Exámenes de clase', path: 'content/examenes/Examenes de clase', status: 'finales de física moderna' },
      { label: 'EVAU', path: 'content/examenes/evau', status: '2012-2025 disponible' },
    ],
  },
]
...
export const nextBuildSteps = [
  ...
  'Ampliar el banco de ejercicios con exámenes de clase y cubrir el tema de sonido.',
